...
var DropBox = React.createClass({
  ...
  render: function() {
    return (
        <div class="app box style2" onClick={this.onClick}>
        Drop files here to be a bamf
        {this.state.files.map(function(f, i) {
            return (<Song key={i} file={f} />);
        }, this)}
        </div>
        );
  }
...
React.render(<DropBox />, document.getElementById('dropzone'));
